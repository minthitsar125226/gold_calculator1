...
if menu == "🏠 ပင်မ စာမျက်နှာ":
    ...
    with col2:
        ...
        res_pe = logic.weight_per_inch(ca.number_input("အရှည်(လက်မ)", value=20.0, key="inch_in"), cb.number_input("၁လက်မစာရွေး", 0, key="yway_in"), cc.number_input("၁လက်မစာPt", 1, key="pt_in"))
